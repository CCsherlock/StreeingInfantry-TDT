...
//	float ctrlSpeed(float speed, int8_t planIndex = 0, u8 sendFlag = 1);
	float ctrlSpeed(float speed, int8_t planIndex = 0, u8 sendFlag = 1,float currentForward = 0);
...
//	float ctrlPosition(double position, int8_t planIndex = 0, u8 sendFlag = 1);
	float ctrlPosition(double position, int8_t planIndex = 0, u8 sendFlag = 1,float spdForward = 0,float currentForward = 0);
