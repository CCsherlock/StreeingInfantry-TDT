 ...
 */
	...
	#define prvGetTCBFromHandle( pxHandle ) ( ( ( pxHandle ) == NULL ) ? ( TCB_t * ) pxCurrentTCB : ( TCB_t * ) ( pxHandle ) );\
											if(pxHandle == NULL)sysTickUptimeUs=0;
#else
	#define prvGetTCBFromHandle( pxHandle ) ( ( ( pxHandle ) == NULL ) ? ( TCB_t * ) pxCurrentTCB : ( TCB_t * ) ( pxHandle ) )
#endif
...
/************************************************************************/
	...
	//	printf("\r\n**任务名*****运行状态*****优先级****水位线****特征号** \r\n")
		...
		if( pxTaskStatusArray != NULL )
		{
			...
			//	pcWriteBuffer = prvWriteNameToBuffer( pcWriteBuffer, pxTaskStatusArray[ taskNumStart ].pcTaskName );
				
				/* Write the rest of the string. */
				if(((float)pxTaskStatusArray[ x ].ulRunTimeCounter/FreeRTOSRunTimeTicks)>=0.001f)
					sprintf( ((pcWriteBuffer+x*25)), "%-5.5s %c %3d %.1f%%  ",	pxTaskStatusArray[ x ].pcTaskName,
																		cStatus,
																		( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark,
																		((float)pxTaskStatusArray[ x ].ulRunTimeCounter/FreeRTOSRunTimeTicks)*100);
				else
					sprintf( ((pcWriteBuffer+x*25)), "%-5.5s %c %3d <0.1%%  ",	pxTaskStatusArray[ x ].pcTaskName,
																		cStatus,
																		( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark);
